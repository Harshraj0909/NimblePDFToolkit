...
def add_watermark(input_pdf_stream, watermark_text):
    ...
    watermark_color = Color(0.5, 0.5, 0.5, alpha=0.1)
...
def compress():
    ...
    # No actual compression here due to PyPDF2 limitations, just return original PDF
    return send_file(
        file.stream,
        as_attachment=True,
...
def image2pdf():
    ...
    try:
        ...
        # Convert to RGB if image is RGBA or P (PDF doesn't support alpha channel)
        ...
        return f"Error converting image to PDF: {e}", 500
